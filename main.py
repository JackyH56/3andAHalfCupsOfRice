    ...
    while running:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                displayTimer(screen, font, completed)
                ...
                if event.type == pygame.MOUSEBUTTONUP:
                    ...
                    for rectangle in rectList:
                        if rectangle.collidepoint(pos):
                            ...
                            numTargets -= 1
                if numTargets == 0:
                    total_time = (pygame.time.get_ticks() - start - TIME_DELAY) / 1000
...
def displayTimer(screen, font, completed):
    pygame.draw.rect(screen, BLACK, (WINDOW_WIDTH-100,0,100,50))
    text = font.render("%d"%(pygame.time.get_ticks() - 3000), True, WHITE, BLACK)
